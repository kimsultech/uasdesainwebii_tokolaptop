    ...
    <div class="about">
        <v-container>
            ...
            <table class="v-data-table">
                <tbody>
                    <tr>
                        <th class="text-xs-left">Author</th> <td style="padding-left: 25px;">{{ book.author }}</td>
                    </tr>
                    <tr>
                        <th class="text-xs-left">Publisher</th> <td style="padding-left: 25px;">{{ book.publisher }}</td>
                    </tr>
                    <tr>
                        <th class="text-xs-left">Price</th> <td style="padding-left: 25px;" v-if="book.price">Rp. {{ book.price.toLocaleString('id-ID') }}</td>
                    </tr>
                    <tr>
                        <th class="text-xs-left">Weight</th> <td style="padding-left: 25px;">{{ book.weight }}</td>
                    </tr>
                    <tr>
                        <th class="text-xs-left">Stock</th> <td style="padding-left: 25px;">{{ book.stock }}</td>
                    </tr>
                    <tr>
